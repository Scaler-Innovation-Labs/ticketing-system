...
const VALID_TRANSITIONS: Record<string, string[]> = {
  [TICKET_STATUS.OPEN]: [TICKET_STATUS.ACKNOWLEDGED, TICKET_STATUS.CANCELLED, TICKET_STATUS.RESOLVED, TICKET_STATUS.IN_PROGRESS],
  [TICKET_STATUS.ACKNOWLEDGED]: [TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELLED, TICKET_STATUS.RESOLVED],
  [TICKET_STATUS.IN_PROGRESS]: [TICKET_STATUS.RESOLVED, TICKET_STATUS.CANCELLED, TICKET_STATUS.ACKNOWLEDGED],
  [TICKET_STATUS.RESOLVED]: [TICKET_STATUS.CLOSED, TICKET_STATUS.REOPENED],
  [TICKET_STATUS.CLOSED]: [TICKET_STATUS.REOPENED],
  [TICKET_STATUS.REOPENED]: [TICKET_STATUS.ACKNOWLEDGED, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELLED, TICKET_STATUS.RESOLVED, TICKET_STATUS.CLOSED],
