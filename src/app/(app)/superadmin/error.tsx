...
/**
 * SuperAdmin Dashboard Error Page
 * Automatically catches errors in superadmin dashboard routes
 */
			...
			<div className="max-w-md space-y-6 text-center">
				...
				<div className="space-y-2">
					...
					<p className="text-sm text-muted-foreground">
						An error occurred while loading the superadmin dashboard. Please try again.
					</p>
				</div>
